...
urlpatterns = [
    ...
    path("/endpoints/<str:pk>/deliveries", WebhookDeliveryListView.as_view(), name="webhook-delivery-list"),
    path("/deliveries/<str:pk>/redeliver/", WebhookRedeliverView.as_view(), name="webhook-redeliver"),
]
